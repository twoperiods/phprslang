...
| **类型** | `is_null`, `is_int`, `is_float`, `is_string`, `is_bool`, `is_array`, `empty`, `isset`, `unset`, `gettype`, `intval`, `floatval`, `strval`, `boolval` |
...
| **数学** | `abs`, `ceil`, `floor`, `round`, `max`, `min`, `rand`, `mt_rand`, `pow`, `sqrt`, `fmod`, `intdiv` |
| **日期** | `time`, `date`, `strtotime`, `microtime`, `mktime`, `checkdate` |
